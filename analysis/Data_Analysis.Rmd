...
pkg_list = c("ggplot2", "plyr", "tidyr", "dplyr", "rvest", "stringr", "ballr", "magrittr", "rsconnect")
...
df <- data.frame(player = players_2019$player, position = players_2019$pos, age = players_2019$age)  
df
```
